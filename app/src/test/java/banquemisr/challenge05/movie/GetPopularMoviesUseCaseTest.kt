...
class GetPopularMoviesUseCaseTest {
    ...
    * Movie(
                ...
                releaseDate=2024-12-19, posterImg=/d8Ryb8AunYAuycVKDp5HpdWPKgC.jpg
            )

    * */
    private val mockMovies = listOf(Movie(
        id=939243,
        title="Sonic the Hedgehog 3",
        releaseDate="2024-12-19",
        posterImg="/d8Ryb8AunYAuycVKDp5HpdWPKgC.jpg"
    ))
    ...
    fun `invoke should emit remote success and insert data`() = coroutineRule.testScope.runBlockingTest {
        ...
        // Act
        getPopularMoviesUseCase(language, page).collect { results.add(it) }
...
//        assertTrue((error as ErrorType.LocalDatabaseError).error is DatabaseError.IOException)
    ...
    @Test
    fun `invoke should handle empty database response gracefully`() = coroutineRule.testScope.runBlockingTest {
        // Arrange
